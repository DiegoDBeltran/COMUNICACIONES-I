...
# Title: Lab1_parteb
# Author: Gomez_Robert_Beltran_Diego_C1A_G1
...
class lab1_parteb(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Lab1_parteb", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Lab1_parteb")
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab1_parteb")
...
def main(top_block_cls=lab1_parteb, options=None):
